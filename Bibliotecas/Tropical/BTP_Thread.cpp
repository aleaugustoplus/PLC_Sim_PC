/*
 ...
 #           Inserção do sistema de envio de mensagens para janela#
 #----------------------------------------------------------------#
...
void __TROPICALL BTP_Thread::ReiniciarThread()throw(BTP_Excecao*)
{
  if(!hthread)
  {
   ...
   throw new BTP_Excecao(this,"Não foi possivel reiniciar Thread!");
						   ...
						   LPARAM lparam,HWND temp) throw(BTP_Excecao*)
{
  ...
  if(!Janela)
   throw new BTP_Excecao(this,"Não existe janela de destino");
